...
const CodeXCultureWebsite = () => {
  ...
  const testers2025 = ["Deepanshu Soni", "Rachit Kansal", "Prateek Kumar"];
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              A unique celebration that bridges the gap between technology and
              culture, organized by the talented freshers of IIIT Allahabad
              since 2024.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-6 rounded-xl border border-purple-500/20">
                ...
                <p className="text-gray-300">
                  Showcasing technical prowess through coding contests
                   that push
              ...
              <div className="bg-gradient-to-r from-pink-900/30 to-yellow-900/30 p-6 rounded-xl border border-pink-500/20">
                ...
                <p className="text-gray-300">
                  Celebrating one year of Code-X-Culture — a reflection of the vibrant spirit and unity of our college community.
                </p>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 p-8 rounded-2xl border border-purple-500/30">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    ...
                    <span> Coding round announcement </span>
                  </li>
                  <li className="flex items-center space-x-3">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Mark your calendars for this annual celebration
            </p>
          </div>
...
<div className="flex items-center justify-between group relative">
  ...
  <div className="w-5/12 text-right pr-8">
    <div className="bg-gradient-to-r from-purple-900/40 to-purple-800/40 p-6 rounded-xl border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 relative">
      ...
      <p className="text-gray-300 mb-4">
        First Code-X-Culture event launched by passionate freshers
      </p>
  ...
  <div className="relative z-10">
    ...
    {/* Hover Card Connector + Card */}
    <div className="absolute left-full top-1/2 transform -translate-y-1/2 group-hover:opacity-100 opacity-0 transition-all duration-300">
      {/* Line from dot to card */}
      <div className="h-0.5 w-8 bg-purple-500 inline-block"></div>

      {/* Hover Card */}
      <div className="ml-2 w-80 bg-gradient-to-br from-purple-900/95 to-gray-900/95 backdrop-blur-sm p-6 rounded-xl border border-purple-500/30 transform scale-95 group-hover:scale-100 transition-all duration-300">
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-gray-300">{tester2024}</div>
        </div>
      </div>
    </div>
  </div>
...
<div className="flex items-center justify-between group relative">
  ...
  <div className="relative z-10">
    ...
    {/* Hover Card Connector + Card */}
    <div className="absolute right-full top-1/2 transform -translate-y-1/2 group-hover:opacity-100 opacity-0 transition-all duration-300">
      {/* Line from dot to card */}
      <div className="h-0.5 w-8 bg-pink-500 inline-block float-right"></div>

      {/* Hover Card */}
      <div className="mr-2 w-80 bg-gradient-to-br from-pink-900/95 to-pink-800/95 backdrop-blur-sm p-6 rounded-xl border border-pink-500/30 transform scale-95 group-hover:scale-100 transition-all duration-300">
  <h4 className="text-lg font-bold text-pink-300 mb-3">2025 Team</h4>
  <div className="space-y-2 mb-4">
    <h5 className="text-sm font-semibold text-pink-400">Problem Setters:</h5>
    <div className="grid grid-cols-2 gap-1 text-xs text-gray-300">
  ...
  <div className="space-y-2">
    <h5 className="text-sm font-semibold text-pink-300">Problem Testers:</h5>
  ...
  <div className="w-5/12 pl-8">
    <div className="bg-gradient-to-r from-pink-900/40 to-pink-800/40 p-6 rounded-xl border border-pink-500/30 hover:border-pink-400/50 transition-all duration-300 relative">
      ...
      <p className="text-gray-300 mb-4">
        Expanding horizons with new formats and increased participation
      </p>
              ...
              <div className="flex items-center justify-between">
                <div className="w-5/12 text-right pr-8">
                  <div className="bg-gradient-to-r from-yellow-900/40 to-yellow-800/40 p-6 rounded-xl border border-yellow-500/30">
                    ...
                    <p className="text-gray-300">
                      Continuing the tradition with innovative ideas and fresh
                      perspectives
                    </p>
      ...
      <section id="team" className="py-20 bg-gray-800/50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              The passionate minds behind Code-X-Culture
            </p>
          </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300">
                Crafting challenges for the upcoming event
              </p>
            </div>
              ...
              {team2025.map((member, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-xs text-center text-cyan-400 mt-2">
                      Problem Setter
                    </p>
                  </div>
                </div>
              ...
              {testers2025.map((tester, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-center text-emerald-400 mt-2 font-medium">
                      Problem Tester
                    </p>
                  </div>
                </div>
          ...
          <div className="mb-12">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300">
                The visionaries who started the legacy
              </p>
            </div>
            ...
            <div className="text-center mb-12">
              ...
              <div className="inline-block group relative bg-gradient-to-br from-yellow-800/50 to-orange-700/50 p-8 rounded-xl border border-yellow-500/30 hover:border-yellow-400/50 transition-all duration-300 hover:transform hover:scale-105">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm text-center text-yellow-400 mt-2 font-medium">
                    Contest Problem Tester
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 p-8 rounded-2xl border border-gray-600/30">
            ...
            <p className="text-gray-300 mb-6">
              Whether you're a coder, artist, performer, or just someone who
              loves great events - Code-X-Culture has something for everyone.
            </p>
